	...
	for i in text.split(" "):
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"1")
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"12")
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"123")
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"1234")
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"12345")
				results.append(text.lower().split(" ")[0]+text.lower().split(" ")[1]+"786")
				if "singapore" in ips:
